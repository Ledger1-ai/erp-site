...
export const metadata: Metadata = {
  title: "About Us – BasaltERP",
  description: "Learn about BasaltHQ and The Utility Company vision: standardize the core, adapt the edges, and continuously optimize ERP operations.",
  alternates: { canonical: "https://basalthq.com/about" },
  openGraph: {
    title: "About Us – BasaltERP",
    description: "Learn about BasaltHQ and The Utility Company vision.",
