            ...
            <div className="max-w-7xl mx-auto space-y-24">
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    ...
                    <div className="glass-panel p-8 rounded-2xl relative overflow-hidden group">
                        ...
                        <h2 className="text-2xl font-bold text-white mb-4">Autonomous ERP</h2>
                        <p className="text-gray-400 leading-relaxed">
                            BasaltERP isn't just a database; it's an active participant in your business. We engineer AI agents that autonomously prospect, qualify, and close deals, revolutionizing how companies scale their sales and support operations.
                        </p>
                    </div>
